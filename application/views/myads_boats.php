                ...
                <div class="col">
                  <table class="table table-striped tresponsive">
                    <tr class="myads-title">
                      ...
                      <td><?php echo $this->lang->line('boat_type');?></td>
                    ...
                    <tr class="myads-det">
                      ...
                      <td  class="myads-icons">
                        <a href="<?php echo base_url();?>myads/editBoat/<?php echo $boat['id'];  ?>"><i class="far fa-edit"></i></a>
                        <a onclick="return confirm('Are you sure want to delete?');" href="<?php echo base_url();?>myads/deleteBoat/<?php echo $boat['id'];  ?>"><i class="far fa-trash-alt"></i></i></a>
                        <a href="<?php echo $this->common_model->getBoatUrl($boat['id'],$boat['type'],$boat['make']) ?>"><i class="far fa-eye"></i></a>
                      </td>
                    </tr>
                    <?php } ?>   
                  </table>
