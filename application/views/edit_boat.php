          ...
          <div class="postad-cont">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <?php } ?>
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="<?php echo base_url();?>myads/<?php echo ($actionType=='add'?'addBoat':'updateBoat')?>/" enctype="multipart/form-data">

                  <input type="hidden" name="boat_id" id="boat_id" value="<?php echo $boat['id']; ?>"  />

                    <div class="form-group">
                    <label><?php echo $this->lang->line('title');?></label>
                      <input class="form-control" type="text" placeholder="" name="title" value="<?php echo $boat['title']; ?>"  />
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label><?php echo $this->lang->line('select_boat_type');?></label>
                        <select name="boat_typeid" class="form-control m-bot15">
                      ...
                      <div class="form-group">
                        ...
                        <select id="make_id" name="make_id" class="form-control m-bot15">
                                                  ...
                                                  <?php 
                                                  foreach($boat_make as $mk) { 
                                                  ?>
                                                  <option value="<?php echo $mk['id']; ?>" <?php echo ($boat['make_id']==$mk['id']?'selected':'');?>><?php echo $mk['make'];?></option>
                                                  <?php } ?>                                    
                                              </select>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <?php if(!empty($assets)){ 
                        ...
                        <img class="item-view" id='' src="<?php echo base_url().$image; ?>"  /><br>
                                          <a class="btn btn-danger" href="<?php echo base_url()?>myads/removeAssetBoat/<?php echo $img['id'];?>/<?php echo $boat['id'];?>">
                      ...
                      <!-- <div class="control-group">
                                          ...
                                          <img class="item-view" id='' src="<?php echo base_url().$image; ?>"  /><br>
                                          <a class="btn btn-danger" href="<?php echo base_url()?>myads/removeAsset/<?php echo $img['id'];?>/<?php echo $boat['id'];?>">
                                            <i class="fa fa-trash" aria-hidden="true"></i> 
                                          </a>
                      ...
                      <input class="form-control" id="mobile" name="mobile" value="<?php if ($boat['mobile']){ echo $boat['mobile'];} else{ echo $phone_number; } ?>" placeholder=""/>
                      </div>
