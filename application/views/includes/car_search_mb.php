...
function getModelList_mb(id){
  ...
  $(document).ready(function(){ 
    ...
    var make_id = $("#car_make_mb option:selected").attr('value');
    var car_model = $("#car_model_mb option:selected").attr("id");

    //alert(car_model);

    
    getModelList_mb(make_id,car_model);
  });

  function search_car() {  
  
  var car_make = $("#car_make_mb option:selected").attr('id');
  //alert(car_make);
  var car_model = $("#car_model_mb option:selected").attr('id');
...
<div class="search-filter">
  ...
  <input type="hidden" name="st" value="<?php echo $this->input->get('st'); ?>">
                ...
                <div class="form-group">
                  ...
                  <select name="car_make" id="car_make_mb" class="form-control m-bot15" onchange="getModelList_mb(this.value);">
                ...
                <div class="form-group">
                  ...
                  <select name="car_model" id="car_model_mb" class="form-control m-bot15">
                ...
                <div class="form-group">
                  ...
                  <select name="ex_color_id" id="ex_color_id_mb" class="form-control m-bot15">
                ...
                <div class="form-group">
                  ...
                  <select name="specs_id" id="specs_id_mb" class="form-control m-bot15">
               ...
               <!-- <div class="search-btncont">
               <button onClick="search_car()" class="btn"><?php echo $this->lang->line('search');?></button>
               </div> -->

                <button class="search-btncont btn" onClick="search_car()">
                        <div class="stickyfooter">
                        <?php echo $this->lang->line('search');?>
                        </div>
                </button>

                <!-- <a onClick="search_car()" class="btn" type="button">
                  <div class="search-btncont">
                        <div class="stickyfooter">
                        <?php echo $this->lang->line('search');?>
                  </div>
