...
#add_picture{
  ...
  border-color:#ea383e !important;
  font-weight: bold;
  margin-bottom: 5px;
}
#add_picture:hover{
  background-color:#ea383e !important;
  color:white !important;
}
#add_picture:active{
  background-color:#ca3237 !important;
  color:white !important;
}
.photo_progress{
  display: flex;
                ...
                <div class="col-md-6">
                  ...
                  <input type="hidden" name="last_link" value="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" />
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <select id="make_id" name="make_id" class="form-control m-bot15" onchange="getModelList(this.value);">
                                                  ...
                                                  foreach($make as $mk) { 
                                                  ?>
                                                  <option value="<?php echo $mk['id']; ?>" <?php echo ($car['make_id']==$mk['id']?'selected':'');?>><?php echo ($this->uri->segment(1) == 'ar' ? $mk['make_ar']:$mk['make']);?></option>
                                                  <?php } ?>                                    
                                              </select>
                      </div>
                      <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select id="body_type" name="body_type" class="form-control m-bot15">
                      ...
                      <div class="form-group">
                        ...
                        <select name="fuel_type" class="form-control m-bot15">
                                              ...
                                              <option value="<?php echo $ft; ?>" <?php echo ($car['fuel_type']==$ft?'selected':'');?>><?php echo $ft;?></option>
                                              <?php } ?>
                                          </select>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select name="ex_color" class="form-control m-bot15">
                                              <option value=""><?php echo $this->lang->line('exterior_color');?></option>
                                              <?php foreach($color as $cl) { ?>
                                              <option value="<?php echo $cl; ?>" <?php echo ($car['ex_color']==$cl?'selected':'');?>><?php echo $cl;?></option>
                                              <?php } ?>
                      ...
                      <div class="form-group">
                        ...
                        <select name="in_color" class="form-control m-bot15">
                                              <option value=""><?php echo $this->lang->line('interior_color');?></option>
                                              <?php foreach($color as $cl) { ?>
                                              <option value="<?php echo $cl; ?>" <?php echo ($car['in_color']==$cl?'selected':'');?>><?php echo $cl;?></option>
                                              <?php } ?>
                      ...
                      <div class="form-group">
                        ...
                        <select name="specs" class="form-control m-bot15">
                                              <option value=""><?php echo $this->lang->line('select_specification');?></option>
                                              <?php foreach($specs as $sp) { ?>
                                              <option value="<?php echo $sp; ?>" <?php echo ($car['specs']==$sp?'selected':'');?>><?php echo $sp;?></option>
                                              <?php } ?>
                                          </select>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select id="trans" name="trans" class="form-control m-bot15">
                                                  <option value=""><?php echo $this->lang->line('select_transmission');?></option>

                                                  <option value="Manual Transmission" <?php echo ($car['trans']=='Manual Transmission'?'selected':'');?>>Manual Transmission</option>
                                                  <option value="Automatic Transmission" <?php echo ($car['trans']=='Automatic Transmission'?'selected':'');?>>Automatic Transmission</option>
                      ...
                      <div class="form-group">
                          ...
                          <div class="text-center">
                            <button type="button" id="add_picture" class="btn form-control"><i class="fa fa-camera"></i> Add pictures</button>
                      ...
                      <div class="form-group">   
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <div id="roller" class="loaderr hide"></div>
                          </div>
                        </div>
                      </div>             
                    </form>
...
<script>
    function removeeClass() {
      $("#multipleImages").removeClass("hide");
    }
    function adddClass() {
      $("#multipleImages").addClass("hide");
    }	
