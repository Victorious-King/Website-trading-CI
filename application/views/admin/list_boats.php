                              ...
                              <tr>
                                 ...
                                 <td>
                                  <div class="btn-group">
                                      ...
                                      <a onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger" href="<?php echo base_url();?>admin/boats/deleteBoat/<?php echo $boat['id'];  ?>"><i class="icon_close_alt2"></i></a>
                                  </div>
                                  </td>
                              </tr> 
                              <?php } ?>                                                          
