			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-car"></i>Plates</li>						  	
					</ol>
				</div>
			</div>
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td><?php echo $plate['code'];  ?></td>
                                  <td><?php echo $plate['city'];  ?></td>
                                 <td><?php echo $plate['number'];  ?></td>
                                  <td><?php echo $plate['price'];  ?></td>                                 
                                 <td><?php echo $plate['created_dt'];  ?></td>
                                 <td><?php echo $plate['created_by'];  ?></td>

                                 <td>
                                  <div class="btn-group">
                                      <a class="btn btn-primary" href="<?php echo base_url();?>admin/plate/editPlate/<?php echo $plate['id'];  ?>"><i class="fa fa-pencil-square-o"></i></i></a>                               
      
                                      <a onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger" href="<?php echo base_url();?>admin/plate/deletePlate/<?php echo $plate['id'];  ?>"><i class="icon_close_alt2"></i></a>
                                  </div>
                                  </td>
                              </tr> 
                              <?php } ?>                                                          
