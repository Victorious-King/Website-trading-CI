                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              <tr>
                                 ...
                                 <th><i class="icon_mail_alt"></i> Price/day</th>                                 
                              ...
                              <tr>
                                 ...
                                 <td><?php echo $cars['model'];  ?></td>
                                  <td><?php echo $cars['price_per_day'];  ?> AED</td>                                 
                                 <td><?php echo $cars['created_dt'];  ?></td>
                                 <td><?php echo $cars['created_by'];  ?></td>

                                 <td>
                                  <div class="btn-group">
                                      <a class="btn btn-primary" href="<?php echo base_url();?>admin/rents/editCar/<?php echo $cars['id'];  ?>"><i class="fa fa-pencil-square-o"></i></i></a>                               
      
                                      <a onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger" href="<?php echo base_url();?>admin/rents/deleteCar/<?php echo $cars['id'];  ?>"><i class="icon_close_alt2"></i></a>
                                  </div>
                                  </td>
                              </tr> 
                              <?php } ?>                                                          
